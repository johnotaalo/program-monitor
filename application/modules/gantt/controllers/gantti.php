...
class Gantti {
	...
	function __construct($data, $params = array()) {
		...
		$defaults = array('title' => false, 'cellwidth' => 40, 'cellheight' => 40, 'today' => true, );
	...
	function render() {
		...
		foreach ($this->blocks as $i => $block) {
			$html[] = '<li class="gantt-label" data-toggle="popover" data-placement="top" data-title="' . $block['label'] . '"><strong ' . $cellstyle . '>' . $block['label'] . '</strong></li>';
		}
		$html[] = '</ul>';
		$html[] = '</aside>';
