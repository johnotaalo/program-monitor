...
class Gantti {
  ...
  function render() {
    ...
    foreach($this->blocks as $i => $block) {
      $html[] = '<li class="gantt-label data-toggle="tooltip" title="'. $block['label'] .'"><strong ' . $cellstyle . '>' . $block['label'] . '</strong></li>';      
    }
    $html[] = '</ul>';
    $html[] = '</aside>';
    ...
    foreach($this->blocks as $i => $block) {
      ...
      $html[] = '<span class="gantt-block' . $class . '" style="left: ' . $left . 'px; width: ' . $width . 'px; height: ' . $height . 'px"><strong class="gantt-block-label" data-toggle="popover" title="'. $block['label'] .'">' . $days . '</strong></span>';
      $html[] = '</li>';
