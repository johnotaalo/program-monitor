...
class Upload extends MY_Controller
{
    ...
    public function data_upload($activity_id, $insert_table) {
     ...
     */
    public function createAndSetProperties($data, $activity_id, $insert_table, $source = NULL) {
        ...
        foreach ($dataTables as $table) {
            ...
            foreach ($data['data'] as $data1) {
                ...
                $data1['SOURCE'] = (isset($source)) ? $source : ' ';
               ...
               // echo 'inserted [' . $source . '][' . $rowCounter . ']</br>';
                //$rowCounter++;
            }
        }
    }
