...
<div class="modal fade" id="imci_mentorship_upload_activity" >
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="upload_form_here">
				<script>
				$('#upload_form_here').load('imci_mentorship/showUpload');
				</script>

			</div>
			<div class="modal-footer" style="height:45px">
				<button id="imci_mentorship_uploadActivityBtn" type="submit" class="btn btn-primary">
...
<div class="modal fade" id="imci_mentorship_files_modal" >
...
echo base_url(); ?>imci_mentorship/export_Excel/"><i class="fi-page-export-csv"></i>Export to Excel</a>
					<a id="export_pdf" class="btn" style="margin-top:-5px" data-link="<?php
echo base_url(); ?>imci_mentorship/export_PDF/"><i class="fi-page-export-pdf"></i>Export to PDF</a>
				</h4>
			</div>
...
<!-- Add Event modal -->
<div class="modal fade" id="imci_mentorship_manual_update" >
	<div class="modal-dialog" style="width:95%" >

		<div class="modal-content">
			<?php
$formAttr = array('id' => 'manual_entry_form');
echo form_open('imci_mentorship/manual_entry', $formAttr); ?>
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
					&times;
				</button>
...
<script>
		...
		$(document).ready(pageHandler(base_url,'imci_mentorship'));
		$('#policy_link').click(function(){
			window.open(base_url+'imci_mentorship',"_parent");  
});
</script>