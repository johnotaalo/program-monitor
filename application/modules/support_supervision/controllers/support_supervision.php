...
class Support_Supervision extends MY_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('global_model');
		$this -> load -> model('support_supervision_model');
	}
	...
	public function load_activity_list() {
		$results = $this -> global_model -> getActivities('Support_Supervision');
	...
	public function support_supervision_cadre() {
		$results = $this -> support_supervision_model -> support_supervision_cadre();
		...
		$this -> load -> view('support_supervision/charts/chart_grouped', $data);
	}

	public function support_supervision_frequency() {
		$results = $this -> global_model -> getActivities('Support_Supervision');
		$results = $results -> result_array();

		foreach ($results as $activity) {
			if ($activity['activity_name'] == 'Roll out Support_Supervision Training') {
				$query = "SELECT 
...
GROUP BY dates";
		...
		$this -> load -> view('support_supervision/charts/chart_line', $data);
	}
