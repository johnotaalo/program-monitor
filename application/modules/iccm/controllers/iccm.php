...
class ICCM extends MY_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('global_model');
		$this -> load -> model('iccm_model');
	}

	public function index() {
		$data['contentView'] = "iccm/index";
		$data['title'] = "Program Monitor :: ICCM";
		$data['brand'] = 'ICCM';
	...
	public function load_activity_list() {
		$results = $this -> global_model -> getActivities('ICCM');
		...
		foreach ($results->result() as $activity) {
			...
			$activity_action = "<a href='#' class='btn-xs btn-primary iccm_manual_update' id='" . $activity -> activity_id . "' >Manual Entry</a><a href='#' class='btn-xs btn-info iccm_activity_upload' id='" . $activity -> activity_id . "' >Upload</a>
			<a href='#' class='btn-xs  iccm_activity_source' id='" . $activity -> activity_id . "' >View Source Data</a>";
	...
	public function iccm_cadre() {
		$results = $this -> iccm_model -> iccm_cadre();
		...
		$this -> load -> view('iccm/charts/chart_grouped', $data);
	}

	public function iccm_frequency() {
		$dataSource = $series = $columns = $seriesData = array();
		$results = $this -> global_model -> getActivities('ICCM');
...
GROUP BY dates";
		...
		$this -> load -> view('iccm/charts/chart_line', $data);
	}
