...
<div class="standard-graph">	
	<div class="outer">
	<h3>IMCI Distribution by County <span id="limit">(Top 10)</span><i class="fa fa-expand full-screen" data-toggle="tooltip" data-placement="bottom" title="Click Here for More"></i><i style="display:none" class="fa fa-compress full-screen" data-placement="bottom" title="Click Here to Minimize"></i></h3>
