...
class Diarrhoea_Management_CMEs extends MY_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('global_model');
		$this -> load -> model('diarrhoea_management_cmes_model');
	}

	public function index() {
		$data['contentView'] = "diarrhoea_management_cmes/index";
		$data['title'] = "Program Monitor :: Diarrhoea Management CMEs";
		$data['brand'] = 'Diarrhoea Management CMEs';
	...
	public function manual_entry() {
		...
		redirect('diarrhoea_management_cmes');
	}
	...
	public function load_activity_list() {
		$results = $this -> global_model -> getActivities('Diarrhoea Management CMEs');
		...
		foreach ($results->result() as $activity) {
			...
			$activity_action = "<a href='#' class='btn-xs btn-primary diarrhoea_management_cmes_manual_update' id='" . $activity -> activity_id . "' >Manual Entry</a><a href='#' class='btn-xs btn-info diarrhoea_management_cmes_activity_upload' id='" . $activity -> activity_id . "' >Upload</a>
			<a href='#' class='btn-xs  diarrhoea_management_cmes_activity_source' id='" . $activity -> activity_id . "' >View Source Data</a>";
	...
	public function diarrhoea_management_cmes_cadre() {
		$results = $this -> diarrhoea_management_cmes_model -> diarrhoea_management_cmes_cadre();
		...
		$this -> load -> view('diarrhoea_management_cmes/charts/chart_grouped', $data);
	}

	public function diarrhoea_management_cmes_frequency() {
		$dataSource = $series = $columns = $seriesData = array();
		$results = $this -> global_model -> getActivities('Diarrhoea Management CMEs');
...
GROUP BY dates";
		...
		$this -> load -> view('diarrhoea_management_cmes/charts/chart_line', $data);
	}
