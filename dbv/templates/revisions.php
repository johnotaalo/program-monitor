									...
									<?php foreach ($files as $file) { ?>
										...
										<div id="revision-file-<?php echo $revision; ?>-<?php echo ++$i; ?>">
											...
											<div class="alert alert-info heading">
												<button data-role="editor-save" data-revision="<?php echo $revision; ?>" data-file="<?php echo $file; ?>" type="button" class="btn btn-mini btn-info pull-right" style="margin-top: -1px;"><i class="fa fa-save"></i><?php echo __('Save file') ?></button>
