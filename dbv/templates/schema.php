...
<h2><?php echo __('Database schema').'  ('.sizeof($this->schema).' tables)'; ?></h2>
<div class="log"></div>
...
<?php if (isset($this->schema) && count($this->schema)) { ?>
    <form method="post" action="" class="nomargin" id="schema">
        ...
        <button data-role="create" class="btn btn-primary btn-mini"><i class="fa fa-cloud-download"></i><?php echo __('Push to database'); ?></button>
        <button data-role="export" class="btn btn-primary btn-mini"><i class="fa fa-cloud-upload"></i><?php echo __('Export to disk'); ?></button>
    </form>
